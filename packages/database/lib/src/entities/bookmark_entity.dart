...
/// class.
///
/// This is a pure persistence model: it knows nothing about the domain
/// `Bookmark`. Conversion to/from the domain lives in the bookmarks feature's
/// data layer (`BookmarkEntityMapper`) to keep the dependency direction
/// `feature → database`.
@Entity()
